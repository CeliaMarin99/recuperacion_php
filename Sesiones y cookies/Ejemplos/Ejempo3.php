<?php
session_start();//inicia session o continua una ya existente
$inactividad = 5;// 60 segundos de inactividad permitidos
...
$sessionTTL = time() - $_SESSION["timeout"]; //resta el tiempo actual menos el tiempo en el que cargó
